...
import type { SignupInput } from "@hiteshgarg/medium-common";
...
export const Auth = ({type} : {type: "signup" | "signin"}) => {
    ...
    return <div className="h-screen flex justify-center flex-col">
        ...
        <div className="flex justify-center">
            ...
            <div className="pt-4">
                {type === "signup" ? <LabelledInput label="Name" placeholder="Hitesh Garg" onChange={(e) => {
                setpostInputs({
                    ...postInputs,
                    name: e.target.value
                })
            }}></LabelledInput> : null}
            <LabelledInput label="Username" placeholder="hitesh@mail.com" onChange={(e) => {
                setpostInputs({
                    ...postInputs,
